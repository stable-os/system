...
for package in bash glibc coreutils selinux libcap libpcre2 ncurses pkg-builder gmp mpfr mpc gcc git tar zlib curl openssl p11-kit make-ca sed grep gawk readline libffi libtasn1; do
